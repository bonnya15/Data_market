...
for day in np.arange(0,ndays): # cycle to simulate the sliding window
    ...
    for n, k in enumerate(buyers_): # when a new buyer arrives
        ...
        if day == 0 :
            ...
            model_market = Online_SGD(buyers[n].coef_market['w'][0], buyers[n].coef_market['b'][0], learning_rate=0.2,damp_factor=1.02)
            ...
            model_own = Online_SGD(buyers[n].coef_own['w'][0], buyers[n].coef_own['b'][0], learning_rate=0.2,damp_factor=1.02)
